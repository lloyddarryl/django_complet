...
import BarreNavigation from '../components/BarreNavigationEtu';
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mt-6 flex items-center">
          <div className="flex-grow">
            <h2 className="text-2xl font-bold mb-2">
              Bienvenue, <strong>{etudiant.prenom} {etudiant.nom}</strong> !
            </h2>
          ...
          <button 
            ...
            className="ml-4 p-2 rounded-full hover:bg-gray-100 transition text-indigo-600"
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex justify-between items-center mb-4">
              ...
              <button 
                ...
                className="text-indigo-500 font-medium hover:text-indigo-700 flex items-center transition-colors"
              >
